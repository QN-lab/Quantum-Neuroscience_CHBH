...
base_directory='Z:\\Data\\2023_06_20\\Z\\Run\\500_25BW_brain_3\\'
...
base_directory_A='Z:\\Data\\2023_06_20\\Analysis' #################### here!!!!!!!!!!!!!!!!!!!!!
...
ch_names_fl = ['time',   'FL0101-BZ_CL','FL0102-BZ_CL','FL0103-BZ_CL','FL0104-BZ_CL','Input1', 'Stim']
ch_types_fl = ['misc',  'mag', 'mag', 'mag','mag','stim', 'stim']

data_raw_fl=data_fl.T



#data_fl.plot(x='time', y='Input1'),#ylim=(-1e-11,+1e-11))
# plt.show()
...
os.chdir(base_directory_A)
############### events epoching and rejection
#%%
reject_criteria = dict(mag=20e-12)
reject_criteria_f = dict(mag=9e-12)
l_freq_r = 0.01
h_freq_r = 100
l_freq = 1
h_freq = 35
...
evoked_gf=epochs_gf.copy().average(method='mean')
