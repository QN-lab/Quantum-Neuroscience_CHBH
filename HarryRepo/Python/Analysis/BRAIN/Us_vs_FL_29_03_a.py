...
# path = 'Z:\\jenseno-opm\\Data\\2023_03_29_FL_brain\\'
...
#%% Our sensor
path2 = 'Z:\\Data\\2023_03_29_Dipole_Zurich\\'
os.chdir(path2)
...
def do_the_thing(data_raw_name):
    ...
    ch_names = ['chunk', 'Shift Hz', 'time s', 'B_T (pT)', 'Aux1_v','Trig_in2','Demod_X', 'Demod_Y','B_T_cal']
    
    ch_types_g = ['misc', 'misc', 'misc','eeg', 'stim','stim', 'misc', 'misc','mag']
    data_raw_g=data_g.T
