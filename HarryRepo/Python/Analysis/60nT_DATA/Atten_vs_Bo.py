...
daq_m = 'C:/Users/vpixx/Documents/Zurich Instruments/LabOne/WebServer/session_20230215_232845_01/mag_lock_atten_000/'
daq_g = 'C:/Users/vpixx/Documents/Zurich Instruments/LabOne/WebServer/session_20230215_232845_01/grad_lock_atten_000/'
...
for a in looper_F:
    ...
    plt.title('{}nT Lock'.format(F_Param[a]))
    plt.xlim(-10,100)
    plt.ylim(-290,-210)
    plt.ylabel('Non-normalised power (dB_shift)')
...
plt.figure()
plt.plot(F_Param,atten,'o')
plt.xlabel('Amplitude of locked HG field (nT)')
plt.ylabel('Attenuation (dB)')
plt.title('Grad vs Mag attenuation of different locking field')
