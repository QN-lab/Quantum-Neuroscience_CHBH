...
base_directory = r'Z:\Data\2024_09_13_Testing_sensor_noise'

# Define filenames and common bad channels
filenames = [
    '20240905_123027_sub-none_file-EmptyPointg_raw.fif',
    '20240905_123758_sub-none_file-EmptyPointgWall_raw.fif',
    '20240905_124354_sub-none_file-EmptyPointgFloor5min_raw.fif'
]
bad_channels = ['s3_bz']  # Replace with actual bad channels

# Colors and labels for each run
colors = ['red', 'blue', 'green']
labels = ['Screen', 'Wall', 'Floor']
